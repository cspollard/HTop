...
ptcSyst :: Reweight1D
ptcSyst = histogram xbins vals
  where
    xbins = arbBin [0, 6, 12, 18, 24, 30, 36, 42, 48, 54, 60, 66, 72, 78, 84, 90, 96, 102, 108, 114, 120]
    vals =
      (*2) <$>
        [ 1.71308133063, 1.16568533933, 1.13982655842, 1.08742491419
        , 1.04325359914, 1.05083363388, 1.01817288382, 1.0244424562
        , 1.02410455619, 0.953244343778, 0.923019295557, 0.93672805042
        , 0.904691072325, 0.911226609601, 0.918449288917, 0.952887688991
        , 0.828543623979, 0.920025730025, 0.895245310776, 1.00492546351
        ]
