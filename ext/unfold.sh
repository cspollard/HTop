...
stack exec run-htop-unfold -- --mcmcfile unfold/mcmc/data/zbtcmcmc.dat --nsamples 500000 --yodafolder unfold/particlelevel/data/unfoldzbtc --xsecfile ext/XSection-MC15-13TeV.data --observable zbtc hist/*hist.gz > unfold/mcmc/data/zbtc.log 2>&1
...
stack exec run-htop-unfold -- --mcmcfile unfold/mcmc/data/zblmcmc.dat --nsamples 500000 --yodafolder unfold/particlelevel/data/unfoldzbl --xsecfile ext/XSection-MC15-13TeV.data --observable zbl hist/*hist.gz > unfold/mcmc/data/zbl.log 2>&1
...
stack exec run-htop-unfold -- --mcmcfile unfold/mcmc/data/zbrelcmcmc.dat --nsamples 500000 --yodafolder unfold/particlelevel/data/unfoldzbrelc --xsecfile ext/XSection-MC15-13TeV.data --observable zbrelc hist/*hist.gz > unfold/mcmc/data/zbrelc.log 2>&1
