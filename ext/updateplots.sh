mkdir -p particlelevel/closure
mkdir -p particlelevel/data

yodamerge -o htop.yoda particlelevel/data/unfold*/htop.yoda
...
yodamerge -o htop.yoda particlelevel/closure/unfold*/htop.yoda
...
rivet-mkhtml -m ".*/elmujj/.*" --mc-errs --pwd -c ext/htop.plot yoda/data.yoda yoda/nominal.yoda yoda/ps.yoda yoda/me.yoda yoda/rad.yoda yoda/puwgt.yoda yoda/background.yoda:"backgrounds" -o detectorlevel/plots
